...
# Get the Accession to make it easier to join the files
accession = str(snakemake.wildcards.accession)
...
output_file.write(("Reference,Depth,Position,Reference Base,Consensus Base,"
                    ...
                    "DelsLTE10,DelsLTE50,DelsLTE100,DelsLTE500,DelsLTE1000,DelsLTE1500,DelsGT1500,Accession\n"))
...
for line in mpileup_file:
    ...
    new_line = (f"{reference},{total},{position},{reference_base},{most_prevalent_base},"
                ...
                f"{dels_10},{dels_50},{dels_100},{dels_500},{dels_1000},{dels_1500},{dels_GT_1500},{accession}\n")  
