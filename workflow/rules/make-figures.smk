...
rule plot_rbd_escape_mutations:
    ...
    output: join(config['figure_dir'], "rbd_escape_mutations.png") 
    conda: "../envs/r.yml"
...
rule plot_all_spike_mutations:
    ...
    """
    input: join(config['pileup_dir'], "pysam_variants.csv") 
    output: join(config['figure_dir'], "all_spike_mutations.png") 
    conda: "../envs/r.yml"
...
rule plot_coverage_in_spike:
    ...
    output: join(config['figure_dir'], "coverage_over_spike.png") 
